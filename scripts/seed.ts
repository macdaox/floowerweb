...
const pages = [
  { id: "page-home", key: "home", sections: [
    { type: "hero", eyebrow: "Artificial Flowers & Plants for Wholesale", title: "Nature, reimagined.", image: { src: "/assets/everstem-hero-magnolia-v3.png", alt: "Sculptural artificial magnolia arrangement in a refined commercial lobby" } },
    { type: "richText", heading: "Our approach", document: document(["We create botanical forms that bring the quiet presence of nature into contemporary spaces."]) },
    { type: "imageText", eyebrow: "The detail", title: "The detail matters.", body: "From the texture of a leaf to the structure of a stem, every detail is considered.", image: { src: "/assets/everstem-detail-v2.jpg", alt: "Macro view of textile petals, molded leaf veins and a wrapped stem" } },
  ...
  ], seoTitle: "EVERSTEM | Artificial Flowers and Botanical Objects", seoDescription: "Artificial flowers, plants and trees for wholesale buyers worldwide." },
