...
Running `npm run admin:create` again synchronizes the configured initial administrator email and password into D1; it will not create a second initial administrator.
